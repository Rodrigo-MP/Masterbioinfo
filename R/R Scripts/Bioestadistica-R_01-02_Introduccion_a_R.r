...
## Sesi�n 02: Variables y objetos de R
##
################################################################################
################################################################################
...
x
is.na(x)
sum(is.na(x))    ## N�mero de missings en x
mean(x)
mean(x,  na.rm=T)
...
a <- c("Hola", "Adi�s")
b <- "Hoy es un buen d�a"
length(a)
length(b)

paste( "Me dijo", a[1], "y yo le respond�", a[2])
paste( "Me dijo", a[1], "y yo le respond�", a[2], sep="-" )
paste( "Me dijo", a[1], "y yo le respond�", a[2], sep="" )
...
list1[[1]]
list1[[2]]
list1[[2]] [3]    ## 3� elemento del 2� componente

names(list1) <- c("var", "vector", "texto")
list1
list1$vector

## Alternativa  (as� se usa con los resultados de las funciones)
